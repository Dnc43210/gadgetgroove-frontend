      ...
      <div class="flex items-center justify-center min-h-screen bg-gray-100">
            <div class="w-3/5 bg-white shadow-lg">
                <div class="flex justify-between p-4">
                    <div>
                        <h1 class="text-3xl italic font-extrabold tracking-widest text-indigo-500">Matrix International</h1>
                    ...
                    <div class="p-2">
                        <ul class="flex">
                            ...
                            <li class="flex flex-col p-2 border-l-2 border-indigo-200">
                                ...
                                <span class="text-sm">
                                # 9/8, 4th Main, 6th Cross, Balashettappa Compound, Rajajinagar Industrial Town, Bengaluru, 560010
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-end justify-end space-x-3">
                        <button class="px-4 py-2 text-sm text-green-600 bg-green-100" onClick={window.print}>Print</button>
                        <button class="px-4 py-2 text-sm text-black-600 bg-yellow-100" onClick={() => window.location = 'mailto:yogita_shinde1@persistent.com'}>Mail Invoice</button>
